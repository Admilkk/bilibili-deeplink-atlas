...
<RouteActions route="bilibili://campus/alumnae_feedback" />
...
- `campus_id`：该路由使用的路径参数，需结合业务上下文判定具体取值。
...
<RouteActions route="bilibili://campus/home" />
...
<RouteActions route="bilibili://campus/home_tab" />
...
<RouteActions route="bilibili://campus/home_tab/recommend" />
...
<RouteActions route="bilibili://campus/index/recommend" />
...
- `dynamic_id`：该路由使用的路径参数，需结合业务上下文判定具体取值。
...
<RouteActions route="bilibili://campus/search" />
