...
本页收录前缀 `album` 下的全部 bilibili 协议 路由，主要对应“相册”相关页面、容器或业务入口。
...
- 类型：`native`
- 说明：这是一个哔哩哔哩协议路由，归入“相册 / picid 参数”相关能力，当前静态标记类型为 原生。
...
- 来源：`apktool_out/smali_classes14/com/bilibili/lib/brouter/internal/routes/codegen/p00.smali:600`
